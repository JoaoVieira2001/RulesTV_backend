...
public class AuthGroupController {
    ...
    @PostMapping("/post/user/{userId}/group/{groupName}")
    @PreAuthorize("hasRole('ADMIN')")
    public String addUserToGroup(@PathVariable String groupName, @PathVariable Integer userId) {
        try {
            authGroupService.addUserToGroup(userId, groupName);
    ...
    @DeleteMapping("/delete/user/{userId}/group/{groupName}")
    @PreAuthorize("hasRole('ADMIN')")
    public String removeUserFromGroup(@PathVariable Integer userId, @PathVariable String groupName) {
        try {
            authGroupService.removeUserFromGroup(userId, groupName);
